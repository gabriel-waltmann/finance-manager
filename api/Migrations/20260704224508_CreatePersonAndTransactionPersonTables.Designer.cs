...
namespace api.Migrations
{
    ...
    [Migration("20260704224508_CreatePersonAndTransactionPersonTables")]
    partial class CreatePersonAndTransactionPersonTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.Person.PersonModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("api.Models.TransactionPerson.TransactionPersonModel", b =>
                {
                    ...
                    b.HasIndex("PersonId", "TransactionId")
                        .IsUnique()
                        .HasFilter("deleted_at IS NULL");
            ...
            modelBuilder.Entity("api.Models.TransactionPerson.TransactionPersonModel", b =>
                {
                    b.HasOne("api.Models.Person.PersonModel", null)
                        .WithMany()
